...
class _MyAppState extends State<MyApp> {
  ...
  Future<List> fetchData() async {
    var uri = Uri.parse('http://172.20.10.6/restapi_p5/list.php');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('PHP MySQL CRUD - 20210120014'),
        automaticallyImplyLeading: false,
        centerTitle: true, // icon "arrow left"
      ),
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          ...
          // Pembaruan data hanya jika result bukan null
          if (result != null) {
            refreshData();
          }
        },
